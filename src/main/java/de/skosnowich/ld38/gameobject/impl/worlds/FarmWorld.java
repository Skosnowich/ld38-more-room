...
public class FarmWorld extends MedievalWorld
{

	public FarmWorld(String name, float x, float y, Team owner)
	{
		super(name, x, y, 10, 2, owner);

		Sprite baseSprite = new Sprite(Assets.getInstance().getTexture(AssetConstants.FARM_TEXTURE));
		Sprite teamSprite = new Sprite(Assets.getInstance().getTexture(AssetConstants.FARM_TEAM_TEXTURE));
