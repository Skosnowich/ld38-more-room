...
public class PlanetSmallWorld extends SpaceWorld
{

	public PlanetSmallWorld(String name, float x, float y, Team owner)
	{
		super(name, x, y, 10, 2, owner);
		Sprite baseSprite = new Sprite(Assets.getInstance().getTexture(AssetConstants.PLANET_SMALL_TEXTURE));
		Sprite teamSprite = new Sprite(Assets.getInstance().getTexture(AssetConstants.PLANET_SMALL_TEAM_TEXTURE));
